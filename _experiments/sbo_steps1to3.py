...
def execute_multiple_runs(lp_file: str, experiment_id: str, num_exec: int, ansatz: str, ansatz_params: dict, 
    ...
    refx, refval = get_cplex_sol(lp_file.replace('.lp','-nocplexvars.lp'), obj_fn)
...
if __name__ == '__main__':
    ...
    execute_multiple_runs(**doe['1/31bonds/TwoLocalxx1rep_piby3_AerSimulator_0.1'], instance='', run_on_serverless=False)
