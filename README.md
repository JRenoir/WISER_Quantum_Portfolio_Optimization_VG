...
Our ansatz demonstrates **higher speed** by achieving the optimal solution in most experiments (We did 10 experiments for each ansatz) with **fewer iterations** than the standard TwoLocal and BFCD ansatz (see the convergence figure below, generated by `/_experiments/Analysis_total.py`; for more details, refer to the Project Presentation Deck).

<p align="center">
<img width="600" height="1304" alt="Image" src="https://github.com/user-attachments/assets/e38c4496-541c-4ef3-8a97-60560e35fd5f" />
</p>

We have successfully completed **Tasks 1–5**. To improve **scalability** for large-scale problems, we designed an **entanglement map based on a Small-World graph**, which enhances connectivity efficiency while preserving problem structure. The method is described in detail in **Appendix I**.
